...
- Page 12 sentence suppose to be: The cell nucleus size is significant in determining the presence of cancer as an unhealthy cell nucleus always at the end spectrum, whether it is smaller or larger than a normal cell nucleus with an abnormal shape. 
